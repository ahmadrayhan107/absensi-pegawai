...
<body class="bg-blue-100">
  ...
  <div class="container h-[100vh] flex items-start md:items-center justify-center">
    <div class="md:w-[600px] w-4/5 rounded-lg bg-white p-10 my-10 md:my-0 shadow-lg">
      <form action="<?= BASE_URL ?>/Pegawai/update/<?= $url[5] ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="block w-full">
          ...
          <div class="relative rounded-md shadow-sm">
            ...
            <input type="text" placeholder="Nama Pegawai" name="nama_pegawai" id="name"
              class="text-md text-md z-10 mb-5 block w-full rounded-md border-2 border-slate-400 p-2 px-12 text-center text-secondary shadow-sm focus:outline-primary"
          ...
          <div class="relative rounded-md shadow-sm">
            ...
            <input type="number" placeholder="No. Telepon" name="telepon" id="phone"
              class="text-md text-md z-10 mb-5 block w-full rounded-md border-2 border-slate-400 p-2 px-12 text-center text-secondary shadow-sm focus:outline-primary"
              onKeyPress="return goodchars(event,'0123456789',this)" value="<?= $data['pegawai']['telepon'] ?>" />
          </div>
          ...
          <div class="relative mb-5 rounded-md shadow-sm">
            ...
            <select name="department" id="department"
              ...
              <option value="<? $data['pegawai']['department'] ?>"><? $data['pegawai']['department'] ?></option>
        ...
        <div class="relative rounded-md shadow-sm">
          ...
          <input type="text" placeholder="Kode Akses" name="kode_akses" id="name"
            class="text-md text-md z-10 mb-5 block w-full rounded-md border-2 border-slate-400 p-2 px-12 text-center text-secondary shadow-sm focus:outline-primary"
            value="<?= $data['pegawai']['kode_akses'] ?>" />
        </div>
        <button name="submit" id="login" type="submit" class="btn-primary w-full mt-5">
          Submit
        </button>
      </form>
    </div>
